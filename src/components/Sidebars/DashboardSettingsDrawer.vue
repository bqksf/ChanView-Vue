	...
	>
        ...
        <a><h6>关于我们</h6></a>
			...
			<div class="download mt-40">
				<a-button type="primary" href="https://www.creative-tim.com/product/muse-vue-ant-design-dashboard-pro" block target="_blank">升级到Pro计划</a-button>
				<a-button type="secondary" href="https://demos.creative-tim.com/muse-vue-ant-design-dashboard/documentation" block target="_blank">联系客服</a-button>
			</div>
			<div class="sharing">
				<h6>您还可以加入我们的群组!</h6>
